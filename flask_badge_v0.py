...
dataset = dataset.drop(["EmployeeStatusDesc","Domain","Sub Domain","Badge Type","Badge Status","Key-Badge_SD","Badge earned","Initiate a badge date","Time Lapse","Badge Classification"],axis = 1)
X = dataset.iloc[:, 1:4]
...
df = pd.read_pickle('C:/Users/KPATNAIk/Desktop/data_science/saved_data.pkl')
df = df.append(X, ignore_index=True)    
df = df.iloc[:, 0:48]
df = df.fillna(0)
# Feature Scaling
scaler = pickle.load(open('C:/Users/KPATNAIk/Desktop/data_science/scaler.pkl', 'rb'))
X1 = scaler.transform(df)
#X1 = sc.transform(X)
loaded_model = pickle.load(open('C:/Users/KPATNAIk/Desktop/data_science/nn_classifier.pkl', 'rb'))
predicted = loaded_model.predict(X1)
#predicted = classifier.predict(X1)
encoder = pickle.load(open('C:/Users/KPATNAIk/Desktop/data_science/encoder.pkl', 'rb'))
...
concatinated.to_csv('C:/Users/KPATNAIk/Desktop/data_science/concatinated.csv')

# import data
model_output = concatinated
source_data = pd.read_pickle('C:/Users/KPATNAIk/Desktop/data_science/root_data.pkl')
...
final_badge.to_csv('C:/Users/KPATNAIk/Desktop/data_science/final_badge.csv')
GPN_Reco_5.to_csv('C:/Users/KPATNAIk/Desktop/data_science/GPN_Reco_5.csv')
